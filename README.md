...
- 🎯 Entry points to execute your program using `python -m <python_baserow_simple>` or `$ python_baserow_simple` with basic CLI argument parsing.
...
```py
from python_baserow_simple import BaseClass
from python_baserow_simple import base_function
...
```bash
$ python -m python_baserow_simple
#or
$ python_baserow_simple
```
